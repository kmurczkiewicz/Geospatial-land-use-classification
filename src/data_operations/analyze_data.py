...
def analyze_data(paths, data_dict):
    ...
    for key, value_dict in data_distribution.items():
        ...
        plot_data(paths, data_distribution, key)
        show_example_data(paths, data_dict, key)


def plot_data(paths ,data_distribution, key):
    """
...
def show_example_data(paths ,data_dict, key):
    """
